...
public class PathwayShadow implements Pathway, ShadowClass
{
    ...
    @Override public String toString() { return "Pathway [curated=" + (curated == null ? "null" : "\"" + curated + "\"") + ", description=" + (description == null ? "null" : "\"" + description + "\"") + ", id=" + id + ", identifier=" + (identifier == null ? "null" : "\"" + identifier + "\"") + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", shortName=" + (shortName == null ? "null" : "\"" + shortName + "\"") + "]"; }
