...
public class HomologueShadow implements Homologue, ShadowClass
{
    ...
    // Attr: org.intermine.model.bio.Homologue.homologyType
    protected java.lang.String homologyType;
    public java.lang.String getHomologyType() { return homologyType; }
    public void setHomologyType(final java.lang.String homologyType) { this.homologyType = homologyType; }
    ...
    // Attr: org.intermine.model.bio.Homologue.confidence
    protected java.lang.String confidence;
    public java.lang.String getConfidence() { return confidence; }
    public void setConfidence(final java.lang.String confidence) { this.confidence = confidence; }
    ...
    @Override public String toString() { return "Homologue [bootstrapScore=" + bootstrapScore + ", clusterId=" + (clusterId == null ? "null" : "\"" + clusterId + "\"") + ", confidence=" + (confidence == null ? "null" : "\"" + confidence + "\"") + ", gene=" + (gene == null ? "null" : (gene.getId() == null ? "no id" : gene.getId().toString())) + ", homologue=" + (homologue == null ? "null" : (homologue.getId() == null ? "no id" : homologue.getId().toString())) + ", homologyType=" + (homologyType == null ? "null" : "\"" + homologyType + "\"") + ", id=" + id + ", lastCommonAncestor=" + (lastCommonAncestor == null ? "null" : "\"" + lastCommonAncestor + "\"") + ", type=" + (type == null ? "null" : "\"" + type + "\"") + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        if ("homologyType".equals(fieldName)) {
            return homologyType;
        }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("homologyType".equals(fieldName)) {
            homologyType = (java.lang.String) value;
        } else if ("lastCommonAncestor".equals(fieldName)) {
            ...
            confidence = (java.lang.String) value;
    ...
    public StringConstructor getoBJECT() {
        ...
        if (homologyType != null) {
            sb.append("$_^ahomologyType$_^");
            String string = homologyType;
            while (string != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) && "ahomologyType".equals(notXml[i])) {
                i++;
                ...
                homologyType = string == null ? notXml[i] : string.toString();
                i++;
            }
            ...
            if ((i < notXml.length) && "aconfidence".equals(notXml[i])) {
                ...
                confidence = string == null ? notXml[i] : string.toString();
                i++;
            }
