...
public class ConsequenceShadow implements Consequence, ShadowClass
{
    ...
    // Attr: org.intermine.model.bio.Consequence.siftQualitativePrediction
    protected java.lang.String siftQualitativePrediction;
    public java.lang.String getSiftQualitativePrediction() { return siftQualitativePrediction; }
    public void setSiftQualitativePrediction(final java.lang.String siftQualitativePrediction) { this.siftQualitativePrediction = siftQualitativePrediction; }
    ...
    // Attr: org.intermine.model.bio.Consequence.siftNumericalValue
    protected java.lang.String siftNumericalValue;
    public java.lang.String getSiftNumericalValue() { return siftNumericalValue; }
    public void setSiftNumericalValue(final java.lang.String siftNumericalValue) { this.siftNumericalValue = siftNumericalValue; }

    // Attr: org.intermine.model.bio.Consequence.alternateAllele
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if ("siftQualitativePrediction".equals(fieldName)) {
            return siftQualitativePrediction;
        }
        ...
        if ("siftNumericalValue".equals(fieldName)) {
            return siftNumericalValue;
        }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        ...
        } else if ("siftQualitativePrediction".equals(fieldName)) {
            siftQualitativePrediction = (java.lang.String) value;
        } else if ("referenceCodon".equals(fieldName)) {
            referenceCodon = (java.lang.String) value;
        } else if ("cdnaPosition".equals(fieldName)) {
        ...
        } else if ("siftNumericalValue".equals(fieldName)) {
            siftNumericalValue = (java.lang.String) value;
    ...
    public StringConstructor getoBJECT() {
        ...
        if (siftQualitativePrediction != null) {
            sb.append("$_^asiftQualitativePrediction$_^");
            String string = siftQualitativePrediction;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
        ...
        if (siftNumericalValue != null) {
            sb.append("$_^asiftNumericalValue$_^");
            String string = siftNumericalValue;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        for (int i = 2; i < notXml.length;) {
            ...
            if ((i < notXml.length) && "asiftQualitativePrediction".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                siftQualitativePrediction = string == null ? notXml[i] : string.toString();
                i++;
            }
            ...
            if ((i < notXml.length) && "asiftNumericalValue".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                siftNumericalValue = string == null ? notXml[i] : string.toString();
                i++;
            }
