...
public class ProbeShadow implements Probe, ShadowClass
{
    public static final Class<Probe> shadowOf = Probe.class;
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.Probe.class.equals(getClass())) {
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.Probe.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.Probe.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.ProbeShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.Probe");
        if (source != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.ProbeShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.Probe)");
        }
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.Probe.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.Probe.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
