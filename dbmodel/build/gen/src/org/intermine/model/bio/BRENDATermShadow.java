...
public class BRENDATermShadow implements BRENDATerm, ShadowClass
{
    public static final Class<BRENDATerm> shadowOf = BRENDATerm.class;
    // Col: org.intermine.model.bio.BRENDATerm.samples
    protected java.util.Set<org.intermine.model.bio.ExpressionMetadata> samples = new java.util.HashSet<org.intermine.model.bio.ExpressionMetadata>();
    public java.util.Set<org.intermine.model.bio.ExpressionMetadata> getSamples() { return samples; }
    public void setSamples(final java.util.Set<org.intermine.model.bio.ExpressionMetadata> samples) { this.samples = samples; }
    public void addSamples(final org.intermine.model.bio.ExpressionMetadata arg) { samples.add(arg); }
    ...
    @Override public boolean equals(Object o) { return (o instanceof BRENDATerm && id != null) ? id.equals(((BRENDATerm)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "BRENDATerm [description=" + (description == null ? "null" : "\"" + description + "\"") + ", id=" + id + ", identifier=" + (identifier == null ? "null" : "\"" + identifier + "\"") + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", namespace=" + (namespace == null ? "null" : "\"" + namespace + "\"") + ", obsolete=" + (obsolete == null ? "null" : "\"" + obsolete + "\"") + ", ontology=" + (ontology == null ? "null" : (ontology.getId() == null ? "no id" : ontology.getId().toString())) + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.BRENDATerm.class.equals(getClass())) {
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.BRENDATerm.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.BRENDATerm.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.BRENDATermShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.BRENDATerm");
        if (identifier != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.BRENDATermShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.BRENDATerm)");
        }
        ...
        samples = new ProxyCollection<org.intermine.model.bio.ExpressionMetadata>(os, this, "samples", org.intermine.model.bio.ExpressionMetadata.class);
    ...
    public void addCollectionElement(final String fieldName, final org.intermine.model.InterMineObject element) {
        if ("samples".equals(fieldName)) {
            samples.add((org.intermine.model.bio.ExpressionMetadata) element);
        } else if ("relations".equals(fieldName)) {
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.BRENDATerm.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.BRENDATerm.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
