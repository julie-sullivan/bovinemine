...
public class CMOTermShadow implements CMOTerm, ShadowClass
{
    public static final Class<CMOTerm> shadowOf = CMOTerm.class;
    ...
    @Override public boolean equals(Object o) { return (o instanceof CMOTerm && id != null) ? id.equals(((CMOTerm)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "CMOTerm [description=" + (description == null ? "null" : "\"" + description + "\"") + ", id=" + id + ", identifier=" + (identifier == null ? "null" : "\"" + identifier + "\"") + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", namespace=" + (namespace == null ? "null" : "\"" + namespace + "\"") + ", obsolete=" + (obsolete == null ? "null" : "\"" + obsolete + "\"") + ", ontology=" + (ontology == null ? "null" : (ontology.getId() == null ? "no id" : ontology.getId().toString())) + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if (!org.intermine.model.bio.CMOTerm.class.equals(getClass())) {
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.CMOTerm.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.CMOTerm.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.CMOTermShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.CMOTerm");
        if (identifier != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.CMOTermShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.CMOTerm)");
        }
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.CMOTerm.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.CMOTerm.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
